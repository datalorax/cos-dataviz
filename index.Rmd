...
oi <- palette_plot(palette_OkabeIto,
                   color_labels = FALSE) +
  labs(title = "Okabe-Ito") +
  theme(plot.title = element_text(size = 30))

brewer <- palette_plot(brewer.pal(8, "Dark2"),
                       color_labels = FALSE) +
  labs(title = "Color Brewer: Dark2") +
  theme(plot.title = element_text(size = 30))

cs <- palette_plot(qualitative_hcl(8, palette = "Dynamic"),
                   color_labels = FALSE) +
  labs(title = "Colorspace: Dynamic") +
  theme(plot.title = element_text(size = 30))
...
vdis <- palette_plot(cividis(8),
                     color_labels = FALSE) +
  labs(title = "Cividis") +
  theme(plot.title = element_text(size = 30))

brewer <- palette_plot(brewer.pal(8, "Purples"),
                       color_labels = FALSE) +
  labs(title = "Color Brewer: Purples") +
  theme(plot.title = element_text(size = 30))

cs <- palette_plot(sequential_hcl(8, palette = "ag_Sunset"),
                   color_labels = FALSE) +
  labs(title = "Colorspace: ag_Sunset") +
  theme(plot.title = element_text(size = 30))
...
```{r }
library(scico)
sco <- palette_plot(scico(8, palette = 'vik'),
                    color_labels = FALSE) +
  labs(title = "scico: vik") +
  theme(plot.title = element_text(size = 30))

brewer <- palette_plot(brewer.pal(8, "PuOr"),
                       color_labels = FALSE) +
  labs(title = "Color Brewer: PuOr") +
  theme(plot.title = element_text(size = 30))

cs <- palette_plot(diverging_hcl(8, palette = "Purple-Green"),
                   color_labels = FALSE) +
  labs(title = "Colorspace: Purple-Green") +
  theme(plot.title = element_text(size = 30))
...
```{r out.height="500px", out.width="250px"}
knitr::include_graphics("img/dashboard-code.png")
```
